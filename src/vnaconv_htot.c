...
/*
 * vnaconv_htot: convert h-parameters to t-parameters
 */
void vnaconv_htot(const vnaconv_array2_t *h, complex (*t)[2],
	       const double complex *z0)
{
    ...
    const double complex d = k1i / k2i * 2.0 * creal(z2) * h21;
#define T11	t[0][0]
#define T12	t[0][1]
#define T21	t[1][0]
#define T22	t[1][1]

    T11 =  (h11 - z1c + (h12_h21 - h11_h22 + h22 * z1c) * z2c) / d;
    T12 = -(h11 - z1c - (h12_h21 - h11_h22 + h22 * z1c) * z2)  / d;
    T21 =  (h11 + z1  + (h12_h21 - h11_h22 - h22 * z1)  * z2c) / d;
    T22 = -(h11 + z1  - (h12_h21 - h11_h22 - h22 * z1)  * z2)  / d;
}
#undef T22
#undef T21
#undef T12
