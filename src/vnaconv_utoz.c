...
/*
 * vnaconv_utoz: convert u-parameters to z-parameters
 */
	       ...
	       const double complex *z0)
{
    ...
    const double complex d = u11 + u12 - u21 - u22;
#define Z11	z[0][0]
#define Z12	z[0][1]
#define Z21	z[1][0]
#define Z22	z[1][1]

    Z11 = ((u11 - u21) * z1c - (u12 - u22) * z1) / d;
    Z12 = k1i / k2i * (z2 + z2c) / d;
    Z21 = k2i / k1i * (u11 * u22 - u12 * u21) * (z1 + z1c) / d;
    Z22 = ((u11 + u12) * z2c + (u21 + u22) * z2) / d;
}
#undef Z22
#undef Z21
#undef Z12
