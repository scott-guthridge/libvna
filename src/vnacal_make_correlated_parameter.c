 ...
 *   @sigma: standard deviation of the difference between this and other
 */
int vnacal_make_correlated_parameter(vnacal_t *vcp, int other, double sigma)
{
    ...
    vstdp_other = _vnacal_get_parameter(vcp, other);
    if (vstdp_other == NULL) {
