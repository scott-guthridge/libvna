...
/*
 * vnaconv_utoy: convert u-parameters to y-parameters
 */
...
#define Y22	y[1][1]
    ...
    Y11 = ((u11 + u12) * z2c + (u21 + u22) * z2) / d;
    Y12 = -k1i / k2i * (z2 + z2c) / d;
    Y21 = -k2i / k1i * (u11 * u22 - u12 * u21) * (z1 + z1c) / d;
    Y22 = ((u11 - u21) * z1c - (u12 - u22) * z1) / d;
}
#undef Y22
#undef Y21
#undef Y12
